# eInvoice OpenAPI Specification
[![Build Status](https://travis-ci.org/SL-PD/einv.svg?branch=master)](https://travis-ci.org/SL-PD/einv)
...
6. If you did everything correct, https://sl-pd.github.io/einv/ will lead to your new docs
...
- Documentation(ReDoc): https://sl-pd.github.io/einv/
- SwaggerUI: https://sl-pd.github.io/einv/swagger-ui/
- Look full spec:
    + JSON https://sl-pd.github.io/einv/swagger.json
    + YAML https://sl-pd.github.io/einv/swagger.yaml
- Preview spec version for branch `[branch]`: https://sl-pd.github.io/einv/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://sl-pd.github.io/einv/ with url from the message: `Server started <url>`
